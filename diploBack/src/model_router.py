...
def prompt(food, question):
    return f""" You are a helpful assistant in my food classification project.
    Try to answer the question about a dish as best as you can, but you can provide only 1-2 sentences.
    You must always answer the quesstion, don't say "I don't know" or "I can't answer that".
